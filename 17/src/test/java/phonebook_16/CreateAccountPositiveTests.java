...
// Assert that button SignOut is present
    Assert.assertTrue(app.getUserHelper().isElementPresent(By.xpath("//*[.='Sign Out']")));
  }
  ...
  @Test
  public void createAccountPositiveTestRefactor16() {
    app.getUserHelper().clickLoginLink();
    //fillInRegisterLoginForm(new User("user_admin_new2@gmail.com", "Password@1"));
  ...
  @Test
  public void createExistedAccountNegativeTest1Refactor16() {
    SoftAssert softAssert = new SoftAssert();
    app.getUserHelper().click(By.xpath("//a[.='LOGIN']"));
    //fillInRegisterLoginForm(new User("user_admin_new3@gmail.com", "Password@1"));
    app.getUserHelper().fillInRegisterLoginForm(new User()
  ...
  @Test
  public void createExistedAccountNegativeTest2Refactor16() {
    app.getUserHelper().clickLoginLink();
   // fillInRegisterLoginForm(new User("user_admin_new3@gmail.com", "Password@1"));
    app.getUserHelper().fillInRegisterLoginForm(new User()
        .setMail("user_admin_new3@gmail.com")
        .setPassword("Password@1"));
    app.getUserHelper().clickRegistrationButton();
    app.getUserHelper().assertAlertAnd409Error();
  }

  @Test
  public void createExistedAccountNegativeTest3Refactor16() {
    app.getUserHelper().registerUserWithCredentials("user_admin_new3@gmail.com", "Password@1");
    app.getUserHelper().assertAlertAnd409Error();
  }
}
