...
public class UploadDownloadPage extends BasePage {
  ...
  /**
   * <h1>Выполняет последовательность <code>действий с использованием</code> мыши для загрузки файла.</>
   *
   * <p>Метод выполняет следующие шаги:
   * <ol>
   *   <li>Пауза на 1000 миллисекунд.</li>
   *   <li>Клик по элементу {@code uploadFile} с использованием метода {@code clickRectangle}.</li>
   *   <li>Создание объекта {@code Robot} для управления мышью и клавиатурой.</li>
   *   <li>Получение размеров экрана.</li>
   *   <li>Вычисление координат центра правой нижней части экрана.</li>
   *   <li>Перемещение курсора мыши на 50 пикселей вправо от вычисленной X-координаты.</li>
   *   <li>Пауза на 1000 миллисекунд.</li>
   *   <li>Клик мышью по файлу и нажатие клавиши Enter для подтверждения выбора файла.</li>
   * </ol>
   *
   * @return Возвращает текущий объект {@code UploadDownloadPage} для возможности цепочки вызовов методов.
   * @throws RuntimeException если возникает ошибка при создании объекта {@code Robot}.
   */
